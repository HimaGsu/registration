...
<cfif not isDefined("cookie.UserAuth_gradechange") or cookie.UserAuth_gradechange eq false or isDefined("URL.logout")>
	<cflocation url="login.cfm?requested_page=view" addtoken="no">
</cfif>
...
<title>View Registration Adjustment Contacts</title>
...
<div class="wrapper">
  <div class="container_16" id="header">
    ...
    <div class="grid_10 toolbar">Logged in as: <cfoutput>#Cookie.login_name_gradechange#</cfoutput> | <a href="view_contacts.cfm?logout=true">LOGOUT</a></div>
  </div>
  <div class="clear"></div>
  ...
  <div class="container_16 page">
    ...
    <cfif ListFind(gsu_affiliation, "staff", ", ") gt 0 or ListFind(gsu_affiliation, "faculty", ", ") gt 0>
        ...
        <cfinvoke component="gradeChange" method="viewContacts" />
